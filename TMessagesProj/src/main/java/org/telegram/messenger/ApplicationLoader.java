...
import com.blackstar.messenger.utils.CrashlyticsUtils;
...
public class ApplicationLoader extends Application {
    ...
    public static File getFilesDirFixed() {
        ...
        return new File("/data/data/com.blackstar.blackstar/files");
    }
    ...
    public static void startPushService() {
        ...
        if (enabled) {
            if (BlackConfig.keepAliveService) {
