...
import com.blackstar.blackstar.utils.BlackFileLocation;
...
//            }
    ...
    public File getPathToAttach(TLObject attach, String size, String ext, boolean forceCache, boolean useFileDatabaseQueue) {
        ...
        if (attach instanceof TLRPC.PhotoSize) {
            ...
            if (obj.location instanceof BlackFileLocation) {
                return new File(((BlackFileLocation) obj.location).path);
            }
        } else if (attach instanceof TLRPC.TL_videoSize) {
        ...
        } else if (attach instanceof BlackFileLocation) {
            var obj = (BlackFileLocation) attach;
