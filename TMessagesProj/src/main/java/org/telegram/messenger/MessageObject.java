...
import com.blackstar.messenger.boost.encryption.BaseEncryptor;
        ...
        if (messageOwner instanceof TLRPC.TL_messageService) {
            ...
            if (!TextUtils.isEmpty(restrictionReason)) {
                ...
                if (getMedia(messageOwner) instanceof TLRPC.TL_messageMediaDice) {
                    ...
                    messageText = LocaleController.getString("UnsupportedMedia", R.string.UnsupportedMedia).replace("https://telegram.org/update", "https://github.com/" + BlackConstants.APP_GITHUB + "/releases/latest").replace("Telegram", BlackConstants.APP_NAME);
...
//            }
    ...
    public boolean needDrawBluredPreview() {
        return needDrawBluredPreview(!BlackConfig.saveDeletedMessages);
    }
