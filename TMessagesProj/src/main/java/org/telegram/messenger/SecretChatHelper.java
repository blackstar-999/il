            ...
            if (BlackConfig.saveDeletedMessages) {
                ...
                for (var i = 0; i < dialogsWithMessages.size(); i++) {
                    ...
                    AndroidUtilities.runOnUIThread(() -> {
                        // invalidating views
                        getNotificationCenter().postNotificationName(BlackConstants.MESSAGES_DELETED_NOTIFICATION, dialogId, dialogsWithMessageIds.get(dialogId));
                    });
                }
            }
            // --- Black StaR hook
