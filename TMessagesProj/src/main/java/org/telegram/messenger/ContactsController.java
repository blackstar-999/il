...
public class ContactsController extends BaseController {
    ...
    public void checkAppAccount() {
        ...
        try {
            Account[] accounts = am.getAccountsByType(BlackConstants.BUILD_ORIGINAL_PACKAGE);
            systemAccount = null;
        ...
        if (getUserConfig().isClientActivated()) {
            ...
            if (systemAccount == null) {
                try {
                    systemAccount = new Account("" + getUserConfig().getClientUserId(), BlackConstants.BUILD_ORIGINAL_PACKAGE);
