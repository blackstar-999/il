...
import com.blackstar.messenger.utils.FolderIcons;
import com.blackstar.messenger.components.IconSelectorAlert;
...
public class FilterCreateActivity extends BaseFragment {
    ...
    private void fillFilterName() {
        ...
        var result = FolderIcons.getEmoticonFromFlags(flags);
            ...
            switch (viewType) {
                ...
                case 2: {
                    PollEditTextCell cell = new PollEditTextCell(mContext, false, null, view1 -> IconSelectorAlert.show(FilterCreateActivity.this, view1, newFilterEmoticon == null ? "\uD83D\uDCC1" : newFilterEmoticon, (emoticon) -> {
                        ...
                        ((PollEditTextCell) view1.getParent()).setIcon(FolderIcons.getTabIcon(newFilterEmoticon), true);
                        checkDoneButton(true);
                    }));
