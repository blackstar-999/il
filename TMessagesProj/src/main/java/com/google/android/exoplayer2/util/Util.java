...
import com.blackstar.blackstar.exceptions.BlackPrivacyException;
...
public final class Util {
   ...
   */
  public static String getUserAgent(Context context, String applicationName) throws BlackPrivacyException {
    // Black StaR: it's not being called
    throw new BlackPrivacyException();
  }
