...
package com.blackstar.messenger.preferences.components;
...
public class HeaderSettingsCell extends FrameLayout {
    ...
    public HeaderSettingsCell(Context context) {
        ...
        titleTextView.setText(String.format("%s %s", LocaleController.getString(R.string.blackstarAppName), BuildVars.BUILD_VERSION_STRING));
