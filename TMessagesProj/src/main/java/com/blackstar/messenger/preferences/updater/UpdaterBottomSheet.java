...
package com.blackstar.messenger.preferences.updater;
    ...
    public UpdaterBottomSheet(Context context, BaseFragment fragment, boolean available, UpdaterUtils.Update update) {
        ...
        if (available) {
            ...
            doneButton.setOnClickListener(v -> {
                UpdaterUtils.downloadApk(fragment.getContext(), update.downloadURL, BlackConstants.APP_NAME + " " + update.version);
                dismiss();
            });
