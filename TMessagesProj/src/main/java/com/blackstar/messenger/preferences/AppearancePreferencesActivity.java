...
package com.blackstar.messenger.preferences;
...
import com.blackstar.messenger.preferences.components.AvatarCornersPreviewCell;
import com.blackstar.messenger.preferences.components.ChatListPreviewCell;
import com.blackstar.messenger.preferences.components.FabShapeCell;
import com.blackstar.messenger.preferences.components.FoldersPreviewCell;
import com.blackstar.messenger.preferences.components.SolarIconsPreview;
...
public class AppearancePreferencesActivity extends BasePreferencesActivity {
    ...
    private final CharSequence[] styles = new CharSequence[]{
            ...
            LocaleController.getString("Black StaRAppName", R.string.blackstarAppName),
