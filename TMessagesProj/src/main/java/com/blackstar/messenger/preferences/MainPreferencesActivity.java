...
import com.blackstar.messenger.preferences.components.HeaderSettingsCell;
import com.blackstar.messenger.preferences.updater.UpdaterBottomSheet;
...
public class MainPreferencesActivity extends BasePreferencesActivity {
    ...
    protected void onItemClick(View view, int position, float x, float y) {
        if (position == aboutExteraRow) {
            ...
            Browser.openUrl(getParentActivity(), "https://github.com/BlackStaR/BlackStaR");
