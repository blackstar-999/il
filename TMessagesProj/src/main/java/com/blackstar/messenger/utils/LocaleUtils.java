...
public class LocaleUtils {
    public static String getActionBarTitle() {
        ...
        switch (actionBarTitle) {
            case 0:
                title = LocaleController.getString("Black StaRAppName", R.string.blackstarAppName);
                break;
            case 3:
    ...
    public static String getAppName() {
        try {
            return ApplicationLoader.applicationContext.getString(R.string.blackstarAppName);
        } catch (Exception e) {
            return "Black StaR";
        }
    }
