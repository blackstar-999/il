...
package com.blackstar.messenger.utils;
...
public class UpdaterUtils {
    ...
    private static String uri = "https://api.github.com/repos/" + BlackConstants.APP_GITHUB + "/releases/latest";
        ...
        otaQueue.postRunnable(() -> {
            ...
            try {
                if (BuildVars.isBetaApp())
                    uri = uri.replace("/" + BlackConstants.APP_NAME + "/", "/" + BlackConstants.APP_NAME + "-Beta/");
