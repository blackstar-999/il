...
package com.blackstar.blackstar.easy;
...
public class BlackEasyUtils {
    ...
    public static void sendTextMessageSync(
        ...
        var dialogId = BlackGhostUtils.getDialogId(MessagesController.getInstance(currentAccount).getInputPeer(peer));
