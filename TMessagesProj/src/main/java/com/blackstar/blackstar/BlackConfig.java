...
public class BlackConfig {
    ...
    public static void setGhostMode(boolean enabled) {
        ...
        BlackConfig.editor.putBoolean("sendReadPackets", BlackConfig.sendReadPackets).apply();
        BlackConfig.editor.putBoolean("sendOnlinePackets", BlackConfig.sendOnlinePackets).apply();
        BlackConfig.editor.putBoolean("sendUploadProgress", BlackConfig.sendUploadProgress).apply();
        BlackConfig.editor.putBoolean("sendOfflinePacketAfterOnline", BlackConfig.sendOfflinePacketAfterOnline).apply();
    }
    ...
    public static boolean saveDeletedMessageFor(int accountId, long dialogId) {
        ...
        return !user.bot || BlackConfig.saveForBots;
    }
    ...
    public static String getDeletedMark() {
        return BlackConfig.preferences.getString("deletedMarkText", BlackConstants.DEFAULT_DELETED_MARK);
    }

    public static String getEditedMark() {
        return BlackConfig.preferences.getString("editedMarkText", LocaleController.getString("EditedMessage", R.string.EditedMessage));
    }

    public static String getWALMode() {
        return BlackConfig.WALMode ? "WAL" : "OFF";
    }

    public static String getSyncServerURL() {
        return preferences.getString("syncServerURL", BlackConstants.DEFAULT_AYUSYNC_SERVER);
    }
