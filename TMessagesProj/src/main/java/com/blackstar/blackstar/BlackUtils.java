...
public class BlackUtils {
    ...
    public static String getFilename(TLObject obj, File attachPathFile) {
        ...
        var f = BlackUtils.removeExtension(filename);
        ...
        f += "@" + BlackUtils.generateRandomString(6);
        f += BlackUtils.getExtension(filename);

        return f;
    }

    public static String getReadableFilename(String name) {
        var ext = BlackUtils.getExtension(name);
    ...
    public static Pair<Integer, Integer> extractImageSizeFromName(String name) {
        ...
        try {
            ...
            Log.d("BlackStaR", "extractImageSizeFromName fucked", e);
            return null;
        }
    }
    ...
    public static Pair<Integer, Integer> extractImageSizeFromFile(String path) {
        try {
            ...
            Log.d("BlackStaR", "extractImageSizeFromFile fucked", e);
            return null;
        }
    }
