...
public class BlackSavePreferences {
    ...
    public BlackSavePreferences(TLRPC.Message msg, int accountId, long dialogId, int topicId, int messageId, int requestCatchTime) {
        this.message = msg;
    ...
    public BlackSavePreferences(TLRPC.Message msg, int accountId) {
        this.message = msg;
        this.accountId = accountId;
        this.userId = UserConfig.getInstance(accountId).getClientUserId();
