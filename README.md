# Black StaR for Android

![Black StaR Logo](.github/BlackStaR.png)

## What's this fork even about?

**Is it just exteraGram+Telegraher?**

**Black StaR** is a fork of [exteraGram](https://github.com/exteraSquad/exteraGram) with
...
The main difference between Black StaR and Telegraher is that Black StaR **saves** your messages history,
while Telegraher just **caches** them.
It means that you can clean your cache and still have all saved messages.

Also, Black StaR has **full ghost mode**.
...
If you don't want to send crash reports, you can disable it in **Black StaR Preferences**.

**Black StaR** does **NOT** include proprietary **exteraGram** features.
...
Follow our **[Telegram channel](https://t.me/blackstar_channel)** and join our [chat](https://t.me/blackstar_chat)!

Preview versions can be downloaded
from the **[dedicated topic](https://t.me/blackstar_chat/1238)**.

## Want to throw some money?

Developing Black StaR is not such a simple task.
**We'd be grateful for any donation <3**

All available methods can be found **[here](https://ayusync.cloud/ui/donate)**.

## Black StaR Sync? What is it?

**Black StaR Sync** is our synchronization service.
You can either use official server or host your own.
It can sync read states and message history.

Server backend can be found **[here](https://github.com/BlackStaR/BlackStaRSyncBackend)**.
...
1. Clone source code using `git clone https://github.com/BlackStaR/BlackStaR.git`
...
5. Generate application certificate and fill API_KEYS:
   ...
   ```
6. You are ready to compile `Black StaR`

- **Black StaR** can be built with **Android Studio** or from the command line with **Gradle**:

```
./gradlew assembleAfatRelease
```

## Black StaR Localization

We have our own **[Crowdin](https://crowdin.com/project/blackstar)**.

But since **Black StaR** is based on **exteraGram**, also join their project
